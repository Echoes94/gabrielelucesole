            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
              ...
              <AnimatedSection direction="right">
                ...
                <div className="prose-custom mb-4 md:mb-6 space-y-2 md:space-y-3">
                  <p className="font-serif text-xs md:text-sm text-muted-foreground">Da adolescente, soffrivo per il male che vedevo nel mondo. Cercai risposte ovunque: filosofia orientale, spiritualità new age, meditazione trascendentale.<br />
