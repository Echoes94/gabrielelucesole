          ...
          <div className="container-wide">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-12">
              {roadmapLevels.map((level, index) => (
                <AnimatedSection key={index} delay={index * 0.08}>
                  <div
                    className={`rounded-xl p-4 md:p-6 h-full transition-transform duration-300 hover:-translate-y-1 ${level.unlocked ? "bg-gradient-card border border-cyan/30" : "bg-card/50 border border-border/30"}`}
                  >
                    {level.dimension && (
                      <div className="mb-3 md:mb-4 px-2 py-1 rounded-full bg-cyan/10 border border-cyan/20 inline-block">
                    ...
                    <div className="flex items-center justify-between mb-3 md:mb-4">
                      <div className="flex items-center gap-2 md:gap-3">
                        <div
                          className={`w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center ${level.unlocked ? "bg-cyan/20" : "bg-muted/20"}`}
                        >
                          {level.unlocked ? (
                            <Unlock
                              className={`h-4 w-4 md:h-5 md:w-5 ${level.unlocked ? "text-cyan" : "text-muted-foreground"}`}
                            />
                          ) : (
                        ...
                        <div>
                          <span
                            className={`font-display text-xl md:text-2xl ${level.unlocked ? "text-cyan" : "text-muted-foreground"}`}
                          >
                            LV {level.level}
                          </span>
                        </div>
              ...
              {maestriaLevels.map((level, index) => (
                <AnimatedSection key={`maestria-${index}`} delay={(roadmapLevels.length + index) * 0.08}>
            ...
            <AnimatedSection delay={0.15}>
              <div className="rounded-xl p-5 md:p-8 bg-red-950/30 border border-red-500/30 mb-6 md:mb-8">
                ...
                <p className="text-xs md:text-sm text-muted-foreground text-center">
                  ...
                  <span className="text-red-400 font-medium">Gennaio 2026</span>
                </p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.2}>
              <div className="rounded-xl p-4 md:p-6 bg-amber-950/30 border border-amber-500/30 mb-6 md:mb-8">
                ...
                <p className="text-xs md:text-sm text-muted-foreground mb-1.5 md:mb-2">
                  ...
                  <span className="text-amber-400 font-medium">31 dicembre 2025</span>.
                </p>
                <p className="text-xs md:text-sm text-muted-foreground mb-1.5 md:mb-2">
              ...
              <AnimatedSection>
                <div className="glass rounded-xl p-4 md:p-6 border border-border/50">
                  ...
                  <p className="text-center text-xs md:text-sm text-muted-foreground mt-3 md:mt-4 italic">
                    ...
                    indirizzo al professionista giusto. Solo la tua felicità e crescita conta. Ci guadagno solo se ciò
                    che ho da offrirti va bene per te…
                  </p>
                </div>
              </AnimatedSection>
