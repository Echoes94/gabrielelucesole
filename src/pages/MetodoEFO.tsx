...
const comingSoon = [
  { name: "Saggio \"Essere Felici ORA: L'Arte Suprema dell'Alterità\"", value: "98€" },
  { name: "Video Corso Metodo EFO completo", value: "987€" },
  { name: "Aggiornamenti lifetime del Metodo EFO", value: "incalcolabile" }
];
...
const testimonials = [
  ...
  },
  {
    ...
    videoId: "1pN54fKgxhCOuwY3GfGR6w2x_Pu5fD2Yu"
  },
  {
    name: "Luca L.",
            ...
            <AnimatedSection className="text-center mb-12">
              ...
              <div className="flex flex-wrap justify-center gap-4 mt-6">
                <span className="px-4 py-2 rounded-full bg-cyan/10 border border-cyan/20 text-sm">
                  🧠 Neuroscienze (Psicologia Positiva, Mindfulness, Professional Coaching ICF, Ipnosi…)
                </span>
                <span className="px-4 py-2 rounded-full bg-cyan/10 border border-cyan/20 text-sm">
                  ...
                  >
                    ...
                    <div className="space-y-2 pt-4 border-t border-border/50">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {level.achievement && (
                          <span className="text-xs text-amber-400">🏆 "{level.achievement}"</span>
                        )}
                      </div>
                      {level.skill && (
              ...
              <div className="glass rounded-2xl p-8 border border-cyan/20">
                ...
                <div className="flex flex-wrap justify-center gap-6">
                  {credentials.map((cred, i) => (
                    <div key={i} className="w-16 h-16 bg-white/90 rounded-lg p-2 flex items-center justify-center">
