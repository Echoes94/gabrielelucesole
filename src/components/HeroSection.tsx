...
const HeroSection = () => {
  ...
  return <section ref={ref} className="relative min-h-[100svh] flex items-center justify-center overflow-hidden pt-16" aria-labelledby="hero-heading">
      ...
      opacity
        ...
        {/* Subheadline */}
        <motion.p className="font-serif text-lg sm:text-xl md:text-2xl text-muted-foreground max-w-xl mx-auto mb-8 sm:mb-12 leading-relaxed px-2" initial={{
        opacity: 0,
        y: 20
      }} animate={{
        opacity: 1,
        ...
        {/* CTA buttons */}
        <motion.div className="flex flex-col sm:flex-row gap-4 sm:gap-4 justify-center items-center mb-12 sm:mb-20" initial={{
        opacity: 0,
        y: 20
      }} animate={{
        opacity: 1,
