...
const HeroSection = () => {
  ...
  return <section ref={ref} className="relative min-h-[100svh] flex items-center justify-center overflow-hidden pt-16" aria-labelledby="hero-heading">
      ...
      opacity
        ...
        <motion.div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 md:gap-6" initial={{
        opacity: 0
      }} animate={{
        opacity: 1
      }} transition={{
        ...
        delay: 0.5
          ...
          {[
            ...
            <div 
              key={index} 
              className="flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-cyan/10 border border-cyan/20 backdrop-blur-sm"
            >
