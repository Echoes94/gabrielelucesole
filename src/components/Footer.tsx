        ...
        <div className="grid md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center gap-3">
              <img src={logo} alt="L.G. Logo" className="h-10 w-10" />
              <div>
                <span className="font-display text-lg text-foreground block">L.G.</span>
          ...
          {/* Navigation */}
          <div className="space-y-4">
            <h4 className="font-sans text-sm font-medium text-foreground uppercase tracking-wider">Navigazione</h4>
            <nav className="flex flex-col gap-3">
              <Link to="/" className="text-sm text-muted-foreground hover:text-foreground transition-colors duration-300">
                Home
              </Link>
              <Link to="/chi-sono" className="text-sm text-muted-foreground hover:text-foreground transition-colors duration-300">
                Chi Sono
              </Link>
              <Link to="/metodo-efo" className="text-sm text-muted-foreground hover:text-foreground transition-colors duration-300">
                Metodo EFO®
              </Link>
          ...
          {/* Contact */}
          <div className="space-y-4">
            <h4 className="font-sans text-sm font-medium text-foreground uppercase tracking-wider">Contatti</h4>
